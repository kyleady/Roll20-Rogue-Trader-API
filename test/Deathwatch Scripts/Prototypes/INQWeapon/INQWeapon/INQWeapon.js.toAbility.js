...
describe('INQWeapon.prototype.toAbility()', function() {
    ...
    expect(action).to.equal('!useWeapon Knife{"Modifier":"?{Modifier|0}","RoF":"?{Rate of Fire|Single|Called Shot|All Out Attack|Swift Attack}"}');
  });
  ...
  it('should ignore features that require a character if no character is given', function(){
    ...
    expect(action).to.equal('!useWeapon Knife{"Modifier":"?{Modifier|0}","RoF":"?{Rate of Fire|Single|Called Shot|All Out Attack}"}');
  });
  it('should not include the RoF option of All Out Attack if the weapon is not a Melee weapon', function(){
    ...
    expect(action).to.equal('!useWeapon Meltagun{"Modifier":"?{Modifier|0}","RoF":"?{Rate of Fire|Single|Called Shot}"}');
  });
  it('should not include the RoF option of Called Shot if the weapon cannot fire on Single', function(){
    ...
    expect(action).to.equal('!useWeapon Storm Bolter{"Modifier":"?{Modifier|0}","RoF":"?{Rate of Fire|Semi Auto(3)|Full Auto(6)}"}');
  });
  it('should not include a roll20 choice for RoF, if there is only one choice', function(){
    ...
    expect(action).to.equal('!useWeapon Heavy Bolter{"Modifier":"?{Modifier|0}","RoF":"Full Auto(6)"}');
  });
  it('should not include the Roll20 choice of Called Shot if the weapon is Psychic', function(){
    ...
    expect(action).to.equal('!useWeapon Bolt of Change{"Modifier":"?{Modifier|0}","RoF":"Single"}');
  });
  it('should include the Rate of Fire Formula in Parentheses if firing on Semi or Full Auto', function(){
    ...
    expect(action).to.equal('!useWeapon Fire Barrage{"Modifier":"?{Modifier|0}","RoF":"?{Rate of Fire|Single|Semi Auto(PR)|Full Auto(2PR)}"}');
  });
  ...
  it('should include the Lightning Attack option if the weapon is a Melee Weapon and the Character has the Lightning Attack Talent', function(){
    ...
    action = meleeweapon.toAbility(inqcharacter);
    expect(action).to.equal('!useWeapon Knife{"Modifier":"?{Modifier|0}","RoF":"?{Rate of Fire|Single|Called Shot|All Out Attack|Swift Attack|Lightning Attack}"}');
  });
  it('should not include the RoF option or the Modifier option if the weapon has the Spray quality and is not Psychic', function(){
    ...
    expect(action).to.equal('!useWeapon Avenger{"Modifier":"?{Modifier|0}","RoF":"Single","EffectivePR":"?{Effective PsyRating|@{Psychic Character|PR}}"}');

    action = rangedweapon.toAbility(inqcharacter);
    expect(action).to.equal('!useWeapon Flamer{}');
  });
  it('should include an EffectivePR option with a roll20 choice if the weapon is psychic', function(){
    ...
    expect(action).to.equal('!useWeapon Smite{"Modifier":"?{Modifier|0}","RoF":"Single","EffectivePR":"?{Effective PsyRating|@{Psychic Character|PR}}"}');
  });
  it('should include an ammo option if an array of ammunition is given', function(){
    ...
    expect(action).to.equal('!useWeapon Bolter{"Modifier":"?{Modifier|0}","RoF":"?{Rate of Fire|Single|Called Shot|Semi Auto(3)}","Ammo":"?{Special Ammunition||Hellfire|Kraken Rounds}"}');
  });
  it('should not include a roll20 choice in the ammo option if the array has a size of 1', function(){
    ...
    expect(action).to.equal('!useWeapon Bolter{"Modifier":"?{Modifier|0}","RoF":"?{Rate of Fire|Single|Called Shot|Semi Auto(3)}","Ammo":"Vengeance Rounds"}');
  });
  it('should include a roll20 choice in Special if the weapon can use Maximal', function(){
    ...
    var action = inqweapon.toAbility(inqcharacter);
    expect(action).to.equal('!useWeapon Plasma Pistol{"Modifier":"?{Modifier|0}","RoF":"?{Rate of Fire|Single|Called Shot|Semi Auto(2)}","Special":"?{Fire on Maximal?|Use Maximal|}"}');
  });
  it('should record the weapon in options.custum if option.custom was true', function(){
    ...
    expect(action).to.equal('!useWeapon Scything Talons{"custom":"Scything Talons (Melee; D10 + 2 R; Pen 3)","Modifier":"?{Modifier|0}","RoF":"?{Rate of Fire|Single|Called Shot|All Out Attack}"}');
  });
    ...
    expect(action).to.equal('!useWeapon Plasma Pistol{"Range":"100","Modifier":"?{Modifier|0}","RoF":"?{Rate of Fire|Single|Called Shot|Semi Auto(2)}","Special":"?{Fire on Maximal?|Use Maximal|}"}');
  });
    ...
    expect(action).to.equal('!useWeapon Plasma Pistol{"Semi":"3","Full":"5","Modifier":"?{Modifier|0}","RoF":"?{Rate of Fire|Single|Called Shot|Semi Auto(3)|Full Auto(5)}","Special":"?{Fire on Maximal?|Use Maximal|}"}');

		action = meltaweapon.toAbility(inqcharacter, {Special: 'Overheats, Spray'});
    expect(action).to.equal('!useWeapon Infernus Pistol{"Special":"Overheats, Spray"}');
  });
});
