...
require('mock20');
describe('INQQtt.prototype.sureStrike()', function() {
  ...
  it('should do nothing if the character does not have the Sure Strike Talent', function(done){
    Campaign().MOCK20reset();
		var filePath = path.join(__dirname, '..', '..', '..', '..', 'INQTotal.js');
		var MyScript = fs.readFileSync(filePath, 'utf8');
		eval(MyScript);
